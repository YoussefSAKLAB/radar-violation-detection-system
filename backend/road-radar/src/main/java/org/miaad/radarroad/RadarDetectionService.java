package org.miaad.radarroad;

import lombok.extern.slf4j.Slf4j;
import org.miaad.radarroad.models.NewData;
import org.miaad.radarroad.models.Radar;
import org.miaad.radarroad.models.Vehicle;
...
public class RadarDetectionService {
    ...
    public void loadRadars() {
        ResponseEntity<Radar[]> exchange = restTemplate
                .exchange("http://localhost:8890/RADAR-SERVICE/api/radar/radars", HttpMethod.GET, null, Radar[].class);
        ResponseEntity<Vehicle[]> exchangeVehicle = restTemplate
                .exchange("http://localhost:8890/REGISTRATION-SERVICE/api/restVehicle/vehicles", HttpMethod.GET, null, Vehicle[].class);
    ...
    public void submitOverSpeedDetection() {
        ...
        newData.setRegistrationNumber(vehicle.getRegistrationNumber());
