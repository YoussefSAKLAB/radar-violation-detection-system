  ...
  generatePDF(data : any) {
    ...
    let documentDefinition = {
      content: [
        ...
        { text: '_____________________________ Infraction Report _____________________________', style: 'header'},

        { text: `ID: ${data.id}` },
        { text: `Date: ${data.date}` },
        { text: `Vehicle Registration N°: ${data.vehicleMatricule}` },
